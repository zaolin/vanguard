...
var flagsKernelNames = map[string]string{
	FlagAllowDiscards:       CryptFlagAllowDiscards,
	FlagSameCPUCrypt:        CryptFlagSameCPUCrypt,
	FlagSubmitFromCryptCPUs: CryptFlagSubmitFromCryptCPUs,
	FlagNoReadWorkqueue:     CryptFlagNoReadWorkqueue,
	FlagNoWriteWorkqueue:    CryptFlagNoWriteWorkqueue,
}
...
func (v *Volume) SetupMapper(name string) error {
	...
	return CreateAndLoad(name, uuid, 0, table)
}
