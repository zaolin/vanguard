...
// DMVolume represents reader/writer for the data handled by the device mapper table.
...
func OpenUserspaceVolume(flag int, perm fs.FileMode, tables ...Table) (DMVolume, error) {
